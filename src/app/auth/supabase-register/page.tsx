...
import { z } from 'zod';
import { AlertCircle, Github, Mail, User, Eye, EyeOff, CheckCircle } from 'lucide-react';
...
export default function SupabaseRegisterPage() {
  ...
  const { signUp, signInWithProvider, loading, error, clearError, isAuthenticated } = useSupabaseAuth();
          ...
          <CardHeader className="text-center pb-8">
            ...
            >
              ...
              <p className="text-gray-300 mt-2">
                Rejoignez la révolution VoiceCoop
              </p>
            </motion.div>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <AnimatePresence>
              {showSuccess && (
                ...
                >
                  ...
                  <div>
                    <p className="text-green-400 text-sm font-medium">Inscription réussie !</p>
                    <p className="text-green-300 text-xs">Redirection vers la connexion...</p>
                  </div>
                </motion.div>
              )}
            </AnimatePresence>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <Button
                ...
                disabled={loading || isSubmitting || showSuccess}
              >
                {showSuccess ? 'Inscription réussie !' : 'S\'inscrire'}
              </Button>
            </form>
            {/* Séparateur */}
            <div className="relative">
            ...
            <div className="text-center pt-4 border-t border-white/10">
              ...
              >
                ← Retour à l'ancienne inscription
              </Link>
            </div>
          </CardContent>
        </Card>
